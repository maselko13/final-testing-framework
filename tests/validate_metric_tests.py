...
#  '-3.228892345720805 , which is lower than 0.36')
    ...
    @mock.patch("metric_tests.get_observation_data_rees")
    @mock.patch("metric_tests.get_output_rees")
...
# Commented out because of gitlab ewatercycle problems. NEEDS TO BE CODE AGAIN WHEN PIPELINE IS FIXED.
 ...
 # '-2.820040220752988 , which is lower than 0.36')
    ...
    @mock.patch("metric_tests.get_observation_data_lobith")
    @mock.patch("metric_tests.get_output_lobith")
...
# Commented out because of gitlab ewatercycle problems. DOES WORK.
 ...
 # '-2.820040220752988 , which is lower than 0.36')
    ...
    @mock.patch("metric_tests.get_observation_data_schermbeck")
    @mock.patch("metric_tests.get_output_schermbeck")
